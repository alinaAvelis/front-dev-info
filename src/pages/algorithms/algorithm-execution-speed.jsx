	...
	return (
		<>
			<Head>
				...
				<meta
					name="keywords"
					content="сложность алгоритмов js, временная сложность алгоритма, сложность алгоритмов, сложность алгоритма n, оценка сложности алгоритмов, асимптотическая сложность алгоритма, сложность алгоритма o, полиномиальная сложность, экспоненциальное время, frontend, js, javascript, фронтенд"
				/>
					...
					<div className="mt-16  flex page_container">
						<div className="post main  main--not_main">
							...
							<i className="text-xs">
								...
								алгоритма в книге Гид по Computer Science,
								Вильям Спрингер
							</i>
							<p className="text">
								<strong>
								...
								(произносится как «О большое от n» или просто «О
								от n»).{" "}
							</p>
							<p className="text">
								Если какое то свойство изменяет время алгоритма
								на <strong>постоянную величину</strong>, мы{" "}
								<strong>можем</strong> его{" "}
								<strong>игнорировать</strong> - так как его
								влияние не заметно, по сравнению с влиянием
								размера задачи.
							</p>
							<p className="text">
								В большинстве ситуаций рассчитывается{" "}
								<strong>наихудшее время выполнения</strong>,
								которое часто совпадает со средним временем.{" "}
							</p>
							<p className="text">
								...
								расчета времени времени используем только n. То
								есть в худшем случае, время выполнения алгоритма
								равно количеству элементов во входных данных. В
								этом случае интересует не количество шагов, а
								скорость.{" "}
							</p>
							<p className="text">
								...
								. Время их сортировки может отличаться для
								разных алгоритмов. Для одного важна
								отсортированность списка, для другого размер, но
								оба фактора влияют на количество шагов, нужных
								для сортировки.
							</p>
							<p className="text">
							...
							<p className="text">
								...
								большинства задач это лучшее чего можно
								добиться.
							</p>
							<p className="text">
							...
							<p className="text">
								...
								В алгоритме сортировки обрабатывается каждый
								элемент списка, разделяя список на два меньших,
								пока каждый элемент не окажется в своем
								собственном списке.
							</p>
							<ul className="list-none">
								...
								<li className="text-xs">
									...
									Computer Science принимают, что это логарифм
									по основанию 2.)
								</li>
							</ul>
							...
							<p className="text">
								...
								данных, возведенному в некоторую степень. Их
								принято называть быстрыми (Хоть и зависит от
								случая).{" "}
							</p>
							<p className="text">
								<strong>Например,</strong> алгоритм, в котором
								каждый элемент сравнивается со всеми остальными,
								работает за <strong>квадратичное время</strong>{" "}
								- O( n^2).
							</p>
							<h2 className="heading">Экспоненциальное время</h2>
							<p className="text">
								<strong>Экспоненциальное время</strong> - время
								выполнения, это константа, возведенная в
								степень, равную размеру входных данных.
							</p>
							<p className="text">
								<strong>Пример:</strong> Нужно угадать числовой
								код длиной 20 символов из 10 цифр от 0 до 9 -
								количество возможных вариантов 10^20. В этом
								случае полиномиальные алгоритмы окажутся гораздо
								быстрее - 20^10.
							</p>
							<p className="text">
								Часто найти приближенное решение задачи можно за
								полиномиальное время, однако получить точный
								(или близкий к точному) ответ можем лишь за
								экспоненциальное время.
							</p>
							<p className="text">
								<strong>Например, задача коммивояжёра:</strong>{" "}
								Продавец хочет посетить каждый город на своем
								маршруте ровно один раз и вернуться домой,
								преодолев минимальное расстояние.
							</p>
							<p className="text">
								<strong>Получить точный ответ</strong> -
								вычислить все возможные маршруты и сравнить их
								суммарные расстояния (O(n!) возможных путей).
							</p>
							<p className="text">
								Очень{" "}
								<strong>
							...
							<p className="text">
								Но{" "}
								<strong>возможное «достаточно хорошее»</strong>{" "}
								(в пределах <strong> 50 %</strong>от
								оптимального) решение может быть найдено за
							...
							<p className="text">
								В этом примере у нас есть коллекция из n строк.
								Для каждой строки мы выводим сообщение.{" "}
							</p>
							<p className="text">
							...
							<p className="text">
								<strong>Общее время выполнения</strong>{" "}
								O(1)*O(n) = O(n)
							</p>
							...
							<p className="text">
								...
								вызовов, каждый из которых занимает O(1)
								времени.
							</p>
							<p className="text">
							...
							<p className="text">
								Расчет скорости выполнения задачи нужен только
								для определенных задач. Применяйте оптимизацию в
								зависимости от цели. Важно оптимизировать только
								то, что необходимо.{" "}
							</p>
							<p className="text">
							...
							<ul>
								<li>
									...
									интерфейс работает незначительно медленнее,
									чем мог бы, это никого не волнует.
								</li>
								<li>
									2) Алгоритм используется для различных
									программ, которые могу выполнять его
									различно по времени и мы не можем это
									контролировать. В этом случае важнее
							...
							<ul>
								<li>
									...
									миллионы раз, должен быть написан
									максимально эффективно.
								</li>
							</ul>
							<p className="text">
								Можно выбрать алгоритм, который в среднем
								работает немного медленнее, но зато гарантирует,
								что его выполнение никогда не займет больше
								времени, чем мы считаем приемлемым.
							</p>
							<p className="text">
