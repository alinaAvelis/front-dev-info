...
const Post = ({ categories, allPosts }) => {
	...
	return (
		<MainLayout
			...
			headKeywords="Это краткий конспект части о скорости выполнения алгоритма в книге Гид по Computer Science, Вильям Спрингер. Обозначается как O(n) (произносится как «О большое от n» или просто «О от n»).
            Если какое то свойство изменяет время алгоритма на постоянную величину..."
			headDescription="сложность алгоритмов js, временная сложность алгоритма, сложность алгоритмов, сложность алгоритма n, оценка сложности алгоритмов, асимптотическая сложность алгоритма, сложность алгоритма o, полиномиальная сложность, экспоненциальное время, frontend, js, javascript, фронтенд"
		>
